# Guía didáctica de tecnologías para DRONIA

Objetivo: elegir tecnología sin inventar problemas . DRONIA tiene captura con drone offline , subida al volver, procesamiento asíncrono en nube, y salida principal en App Mobile (Android + iOS). Volumen típico por vuelo/salida: 80–100 GB .
...
Esto es lo más conveniente para DRONIA:
...
DRONIA es (1) hardware/captura, (2) ciencia de datos geoespacial, (3) producto. Intentar resolver todo con “un solo lenguaje” suele llevar a pelear con tooling inmaduro o duplicar esfuerzos.
...
**¿Qué es “offline-first” en DRONIA, sin humo?**
...
| --- | --- | --- | --- |
| **Mapa base** | Satélite/calles (terceros). Es el “fondo”. | Liviano | Online cuando hay señal. No lo genera DRONIA. |
...
Esta pestaña resume proveedores y redes que públicamente ofrecen servicios de drones para agricultura de precisión en Argentina. Útil para **partnership** (tercerizar vuelos) o para armar una **red operativa** mientras DRONIA desarrolla software y pipeline. **Nota importante:** la oferta real (sensores disponibles, cobertura geográfica, tiempos y precios) cambia. Usar esto como shortlist y validar por contacto directo y pruebas piloto.
...
- **Para DRONIA:** buen partner si tu modelo necesita datasets multiespectrales bien calibrados.
...
- **Para DRONIA:** partner natural si el MVP apunta a prescripción/accionamiento (aplicar donde hace falta).
...
- **Para DRONIA:** posible proveedor por cobertura y paquetes de servicio; validar sensores exactos y outputs.
...
- **Para DRONIA:** gran referencia de “producto”: del vuelo a la prescripción con SLA claro.
...
- **Para DRONIA:** referencia de “marketplace operativo” (si en el futuro DRONIA escala con red de pilotos).
...
- **Para DRONIA:** buen canal para armar red (con checklist de compliance).
...
- **Propiedad de datos:** que DRONIA pueda usar datasets para mejorar modelos.
...
Ideal para DRONIA: asegurás raws/metadatos y tu pipeline/IA hace el diferencial.
