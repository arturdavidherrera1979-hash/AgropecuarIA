# DRONIA – Guía del repositorio y estructura
...
El repositorio **DRONIA** es el “centro de gravedad” del proyecto: acá viven el código, la documentación y los artefactos de gestión (issues, plantillas, minutas).  
...
|---|---|
| `README.md` | Portada del repo: qué es DRONIA y cómo arrancar |
