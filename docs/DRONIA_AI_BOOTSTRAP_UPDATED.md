...
Leé: docs/AI_BOOTSTRAP.md, docs/guia_repo.md, docs/DRONIA_AI_PROFILE.md, docs/00_vision.md, docs/10_roadmap.md, docs/40_mvp_definition.md
...
## 4.1) Perfil de la IA (AI Profile)
- Este repo incluye el perfil oficial del asistente en `docs/DRONIA_AI_PROFILE.md`.
- **Regla:** al iniciar un chat nuevo, el asistente debe leer ese archivo antes de proponer arquitectura, sensores o plan de datos.
- Cambios al rol/comportamiento del asistente: versionar y actualizar `docs/DRONIA_AI_PROFILE.md`.
